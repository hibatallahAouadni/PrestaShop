...
scenario('Create "Brand" - "Brand address"', () => {
  ...
  scenario('Create a new "Brand address"', client => {
    ...
    test('should Choose the brand name', () => client.waitAndSelectByVisibleText(BrandAddress.branch_select, 'Brand' + date_time));
    ...
    test('should set the "City" input', () => client.waitAndSetValue(BrandAddress.city_input, "paris" + date_time));
